...
flower_five = Flower.create!(
  name: "Bouquet d'automne",
  description: "Bouquet de fleurs dans un camaïeux automnal : brun, orangé, bordeaux..

  Hortensias d'automnes, roses anciennes, baies, et fleurs sélectionnées selon les arrivages...
  Vous souhaitez une précision, privilégier ou éviter une variété de fleurs ?
  Appelez- nous à la boutique, nous vous conseillerons : 04.78.37.38.29",
  price: 38,
  image: "fleur5.jpg"
...
flower_six = Flower.create!(
  name: "Bouquet de saison, coloré et joyeux.",
  description: "Fleurs sélectionnées et choisies chaque semaine.",
  price: 30,
  image: "fleur6.jpg"
)
flower_six.save!
